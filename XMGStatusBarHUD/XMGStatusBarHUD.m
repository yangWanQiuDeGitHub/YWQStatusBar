...
+ (void)showSuccess:(NSString *)msg
{
    ...
    [self showMessage:msg image:[UIImage imageNamed:@"YWQStatusBar.bundle/success"]];
}
...
{
    [self showMessage:msg image:[UIImage imageNamed:@"YWQStatusBar.bundle/error"]];
}
